...
class MainActivity : BaseActivity<ActivityMainBinding>() {
    ...
    private val rtmpServerAdapter: RtmpServerAdapter = RtmpServerAdapter(
        this,
        mutableListOf(
    ...
    override fun initListener() {
        ...
        viewBinding.rvServer.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
